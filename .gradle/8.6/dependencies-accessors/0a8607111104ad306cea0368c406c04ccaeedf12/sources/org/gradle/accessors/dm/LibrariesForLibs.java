...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxRoomLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidxRoomRoomKtx2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxRoomRoomLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ktx4</b> with <b>androidx.room:room-ktx</b> coordinates and
         * with version reference <b>androidxRoomRoomKtx2</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx4() {
            return create("androidx.room.room.ktx4");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxRoomRoomKtx2</b> with value <b>2.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxRoomRoomKtx2() { return getVersion("androidxRoomRoomKtx2"); }
        ...
        /**
         * Version alias <b>lottie</b> with value <b>3.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final SafeargsPluginAccessors paccForSafeargsPluginAccessors = new SafeargsPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.safeargs</b>
         */
        public SafeargsPluginAccessors getSafeargs() {
            return paccForSafeargsPluginAccessors;
        }
    ...
    public static class SafeargsPluginAccessors extends PluginFactory {

        public SafeargsPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>safeargs.kotlin</b> with plugin id <b>androidx.navigation.safeargs.kotlin</b> and
         * with version reference <b>navigationFragmentKtx</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKotlin() { return createPlugin("safeargs.kotlin"); }
